...
/*
 ...
 - Give the buyer all phps @[isON_Set ,isON ,ASExtra ,MessageWhy_Set ,MessageWhy]
 
 - Ask them for @[apps-JSON,mobileConfigLink];
 
 - Tell them to set AppID in Info for notifications
 
 - AppsInfoController.m - 90 \ Change link
 */

// OneSignal_App_ID
// AppDelegate.m
#define AppID [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"APPID"]
//#define AppID @""

// Check_IF_STORE_DISABLED
// SettingsController.m
//#define OnOff_SET [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"OnOff_SET"]
#define OnOff_SET [NSString stringWithFormat:@"%@/Crazy/CMScript/Files/CMCheckins/isON_Set.php", Store_Site]


// AS_ExtraCotroller.m - 40 - isON.php
//#define OnOff_GET [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"OnOff_GET"]
#define OnOff_GET [NSString stringWithFormat:@"%@/Crazy/CMScript/Files/CMCheckins/isON.php", Store_Site]

// PATH_FOR_PHP_NOTIFI.._FILE - IN_SERVER
// PushNotificationsController.m
//#define Notifications_Path [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"Notifications_Path"]
#define Notifications_Path_Admin [NSString stringWithFormat:@"%@/Crazy/CMScript/Files/CMCheckins/Adminotifications.php", Store_Site]


#define Notifications_Path_Users [NSString stringWithFormat:@"%@/Crazy/CMScript/Files/CMCheckins/UsersAdminotifications.php", Store_Site]

// SettingsController.m
//#define MessageWhy_Set [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"MessageWhy_Set"]
#define MessageWhy_Set [NSString stringWithFormat:@"%@/Crazy/CMScript/Files/CMCheckins/MessageWhy_Set.php", Store_Site]

// AS_ExtraCotroller.m - 64
//#define MessageWhy_GET [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"MessageWhy_GET"]
#define MessageWhy_GET [NSString stringWithFormat:@"%@/Crazy/CMScript/Files/CMCheckins/MessageWhy.php", Store_Site]


// AS_ExtraCotroller.m 321
//#define MobileConfigLink [NSString stringWithFormat:@"%@/Crazy/CMScript/UDID/device.mobileconfig",[CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"Site"]];



// USER_JSON
// AS_ExtraCotroller 955


// STORE_NAME
#define StoreName @"CMScript"
...
//@"https://ajbbo.net"
#define Store_Site [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"Site"]

#define GroupIDs [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"GroupIDs"]



//#define MobileConfigLink [NSString stringWithFormat:@"%@/Crazy/CMScript/UDID/Crate_MobileConfig.php?GroupID=%@", Store_Site , [CMManager PlistPath:[CMManager BundlePathWithFileOrDir:@"Info.plist"] ObjectForKey:@"GroupIDs"]]
...
-(UISegmentedControl *) InitSegamentWithSections:(NSArray *)Sections Action:(SEL)Action InView:(UIView *)View;

+(void) AlertWithTitle:(NSString *)Title Message:(NSString *)Message ButtonTitle:(NSString *)ButtonTitle;

+(void) ForLoop:(NSMutableDictionary *)Array Handler:(void (^_Nullable) (NSUInteger Counter) )handler;
